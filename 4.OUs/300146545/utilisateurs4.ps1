...
$users = Get-ADUser -Filter * -SearchBase "OU=Employes,OU=300146545,DC=DC300146545-00,DC=local" -Properties *
...
$computers = Get-ADComputer -Filter * -SearchBase "OU=Ordinateurs,OU=300146545,DC=DC300146545-00,DC=local"
...
Write-Host "DC=DC300146545-00,DC=local" -ForegroundColor Cyan
Write-Host "│" -ForegroundColor White
Write-Host "└── OU=300146545" -ForegroundColor Cyan
Write-Host "    │" -ForegroundColor White
...
Write-Host "Étudiant        : SAOUUDI ALLAOUA " -ForegroundColor Cyan
Write-Host "ID              : 300146545" -ForegroundColor Cyan
Write-Host "Domaine         : DC300146545-00.local" -ForegroundColor Cyan
