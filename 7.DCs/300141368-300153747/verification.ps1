...
$credAD2 = Get-Credential -Message "Entrez le compte administrateur de AD2 (DC300153747-00)"

# --- b. Test de connectivité ---
Write-Host "`nÉtape 2 : Test de connectivité vers DC2..."
Test-Connection -ComputerName dc300153747-00.local -Count 2

# --- c. Interroger AD2 ---
Write-Host "`nÉtape 3 : Informations sur le domaine AD2..."
Get-ADDomain -Server dc300153747-00.local -Credential $credAD2
