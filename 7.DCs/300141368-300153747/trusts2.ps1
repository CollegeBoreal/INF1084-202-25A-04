...
$credAD2 = Get-Credential -Message "Entrez le compte administrateur de AD2 (DC300141369-00)"
...
Get-ADDomain -Server DC300141369.local -Credential $credAD2

Write-Host "`nÉtape 4 : Liste des utilisateurs AD2..."
Get-ADUser -Filter * -Server DC300141369.local -Credential $credAD2 | Select Name, SamAccountName
